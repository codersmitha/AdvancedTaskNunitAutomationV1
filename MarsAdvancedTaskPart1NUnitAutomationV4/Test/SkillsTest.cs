...
namespace MarsAdvancedTaskPart1NUnitAutomation.Test
{
    ...
    public class SkillsTest : CommonDriver
    {
        ...
        {
            skillStepsObj.DeleteSkillRecords();
        ...
        {
            skillStepsObj.AddDuplicateSkillWithDifferentLevel(skillList[0], skillList[4]);
        ...
        {
            skillStepsObj.CancelAddSkillRecord(skillList[0], skillList[8]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithFieldsEdited(skillList[0], skillList[8]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithNoFieldsEdited(skillList[0]);
        ...
        {
            skillStepsObj.UpdateSkillRecordWithInsufficientData(skillList[0], skillList[1]);
        ...
        {
            skillStepsObj.UpdateSkillRecordWithInsufficientData(skillList[0], skillList[9]);
        ...
        {
            skillStepsObj.UpdateSkillRecordWithInsufficientData(skillList[0], skillList[10]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithFieldsEdited(skillList[0], skillList[11]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithFieldsEdited(skillList[0], skillList[12]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithFieldsEdited(skillList[13], skillList[14]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithFieldsEdited(skillList[0], skillList[15]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithFieldsEdited(skillList[0], skillList[16]);
        ...
        {
            skillStepsObj.UpdateExistingSkillRecordWithFieldsEdited(skillList[0], skillList[17]);

        }
        [Test, Order(23), Description("This test Cancels a Skill record before updating")]
        public void TestCancelUpdateSkillRecord()
        {
            skillStepsObj.CancelUpdateSkillRecord(skillList[0], skillList[18]);
